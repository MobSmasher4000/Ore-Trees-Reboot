...
public class ResourceProcessorMenu extends AbstractContainerMenu {
    public final ResourceProcessorBlockEntity blockEntity;
    ...
    public ResourceProcessorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.RESOURCE_PROCESSOR_MENU.get(), pContainerId);
        this.blockEntity = ((ResourceProcessorBlockEntity) entity);
...
//        output slots
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.RESOURCE_PROCESSOR.get());
    }

...
//        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 3, 104, 34));
...
//        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 6, 104, 34));
//        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 7, 104, 34));
//        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 8, 104, 34));
//        this.addSlot(new SlotItemHandler(blockEntity.itemHandler, 9, 104, 34));
//
//        addDataSlots(data);
//    }
//
